...
import es.upm.miw.pd.composite.Dividir;
import es.upm.miw.pd.composite.Expresion;
import es.upm.miw.pd.composite.Multiplicar;
import es.upm.miw.pd.composite.Numero;
import es.upm.miw.pd.composite.Restar;
import es.upm.miw.pd.composite.Sumar;
...
public class ExpressionTest {
	...
	public void ini() {
		...
		this.exp6 = new Sumar(new Restar(new Numero(3), new Multiplicar(
				new Dividir(this.exp1, new Numero(2)), new Numero(3))),
				this.exp1); // ((3-((4/2)*3))+4)
	}
